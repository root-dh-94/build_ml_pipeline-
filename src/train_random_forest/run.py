...
def go(args):
    ...
    logger.info("Downloading training and valdiation dataset from wandb")
    ...
    logger.info("saving inference pipeline as pkl")
    ...
    logger.info("uploading inference pipeline as artifact to wandb")
    artifact = wandb.Artifact(args.output_artifact, 
                              type="model_export", 
                              description="exporting inference pipeline",
                               metadata=rf_config )
